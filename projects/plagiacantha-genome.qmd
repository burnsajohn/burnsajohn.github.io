...
::: {.figure-text}
A single reproductive cell, isolated from the 100 m sample. The video below
shows the same cell after releasing swarmers, the haploid cells the sequencing
strategy runs on.
:::
:::

<video controls preload="metadata" style="max-height: 420px; width: auto; display: block; margin: 0 auto;">
