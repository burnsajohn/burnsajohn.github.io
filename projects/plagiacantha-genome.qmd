...
::: {.figure-text}
**Last sampled September 16, 2026.**
...
::: {.figure-row style="--fig-width: 30%;"}
![An isolated gamont.](../images/plagiacantha/GAMONT.jpg){.figure-col fig-alt="Radiolarian reproductive cell/Gamont"}
...
<video controls preload="metadata" style="max-height: 380px; width: auto; display: block;">
