...
::: {.figure-text}
**Last sampled September 18, 2026.**
...
A sample from 100 m depth in the Gulf of Maine aboard the
[R/V *Bowditch*](https://www.bigelow.org/services/facilities-and-vessels/rv-bowditch/)
returned radiolarians in numbers sufficient for the next steps in the project.
The dock bloom also looks like it may finally be picking up.

::: {.figure-row}
![Life stages of [*Plagiacantha*]{.taxon} sp.](../images/plagiacantha/LIFESTAGES.jpg){.figure-col fig-alt="Four rariolarians at different life stages"}

::: {.figure-text}
Finding cells offshore matters because the dock has been slow this year, and
the deeper water is a second route to material when the bloom is late.
:::
:::

A single reproductive cell, isolated from the 100 m sample. Within 24 hours it
released swarmers, the haploid cells the sequencing strategy runs on.

<div class="media-row">
<figure class="media-item">
<a href="../images/plagiacantha/GAMONT.jpg"><img src="../images/plagiacantha/GAMONT.jpg" alt="Radiolarian gamont"></a>
<figcaption>An isolated gamont.</figcaption>
</figure>
<figure class="media-item">
<video controls preload="metadata">
  <source src="../images/plagiacantha/SWARMERS.mp4" type="video/mp4">
</video>
<figcaption>The same cell after releasing swarmers.</figcaption>
</figure>
</div>

### Update, 20 September 2026

A bloom of the harmful dinoflagellate [*Karenia mikimotoi*](https://wgme.com/news/local/algae-bloom-continues-along-the-maine-coast-experts-say-its-moving-into-new-areas-09-17-2026)
is running in the Gulf of Maine this year, covering the area we sample. It is
affecting shellfish in the region, and it may be connected to the low
radiolarian counts at the Bigelow dock.

The last reported bloom of this species here was in 2017, outside our sampling
window, so it does not appear in our counts and we have no direct comparison.
The radiolarians may have moved deeper, which would keep them from reaching the
dock on the tides, or they may simply not be growing in the shallows while the
dinoflagellate is there. 

At around 20 microns the dinoflagellate passes through our 30 micron net, so we
cannot see the bloom in our own tows either.

We will continue monitoring at the dock and will increase sampling in deeper water to
make sure we have access to cells for the genomics project.
